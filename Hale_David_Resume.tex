...
\begin{itemize} \itemsep 1pt
    ...
    \item   Workflow Design: Established new workflows, designed and set requirements for what can/should be automated based on project requirements,
...
\begin{itemize} \itemsep 1pt
    \item Project Management: Charged with overseeing all coordination and triaging of MTA IT Projects for all updates to proprietary MTA IT systems.
            Responsiblities included identifying requirements, defining acceptance criteria, performing QA UAT, documentation, and performing user trainings on the new software updates.
...
\textbf{\textit{Bachelor of Arts, Mathematics and Philosophy, Economics Minor}}\\
\begin{tabular}{ l l }
    GPA 3.5/4.0\\
