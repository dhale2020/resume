...
=======
=======
>>>>>>> 5f70ca4f79e0f92fead859566eb015dcbbea5a7d
\header{Personal Statement}
\vspace{1mm}
\textbf{What I do is take a business process, break it down into its constituent parts, analyze and resdesign it based on what can be automated efficiently, and either personally automate or project manage the automation,
        then conduct retrainings on the resdesigned workflow, and create end-to-end documentation \& onboarding material to ensure smooth, scalable, and maintainable operations.
}
...
\begin{itemize} \itemsep 1pt
    ...
    % \item   Responsible for creating, standardizing, automating, and maintaining new workflows for claims proccessing in accordance with both 
