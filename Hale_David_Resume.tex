...
\begin{itemize}[leftmargin=10pt,align=left]
    ...
    \item   Workflow Design: Established new workflows, defined and set technical requirements for what can/should be automated based on project requirements,
     ...
     \item Reduced annual worked hours by 5,200 resulting in \$200,000 annual admin savings by automating manual authorization matching workflows resulting in faster TAT, with zero decrease in auto-match accuracy.
