...
\vspace{1mm}
\textbf{What I do is take a business process, break it down into its constituent parts, analyze how to improve it, and either personally automate the parts that can be automated, or project manage the engineering team to create the new automation, and then train operations staff on the resdesigned workflow, and create end-to-end documentation to ensure both smooth operations for current and future staff.
}
