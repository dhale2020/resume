...
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item   Project Manager charged with overseeing all coordination and triaging of MTA IT Projects for all updates to internal systems.
            Responsiblities included identifying requirements, defining acceptance criteria, performing QA UAT, creating documentation for, and performing user trainings on the updated software.
