...
\header{Education}
\textbf{College of Wooster, GPA 3.5/4.0} \hfill September 2015 - June 2019\\
% \begin{itemize}
% 	\item Bachelor's Degree: Double Major in Mathematics and Philosophy, Minor in Economics
% 	\item Recipient of the Melcher P. Fobes Scholarship for high academic achievement.
% 	\item Inducted into honor societies Omicron Delta Epsilon (Economics) and Phi Sigma Tau (Philosophy). 

% \end{itemize}
\begin{tabular}{ l| l }
    Degree:& Bachelor of Arts--Double-major in Mathematics and Philosophy, with Economics Minor\\
