...
\vspace{1mm}
\textbf{What I do is take a business process, break it down into its constituent parts and redesign it, analyze how to improve the process and what can be automated, and either personally automate or project manage the automation,
        then conduct retrainings on the resdesigned workflow, while creating end-to-end documentation \& onboarding material to ensure smooth operations in both current and future states.
}
