...
\vspace{1mm}
\textbf{What I do is take a business process, break it down into its constituent parts, analyze how to improve it and what can be automated, and either personally automate or project manage the automation,
        and retrain operations staff on the resdesigned workflow, while creating end-to-end documentation to ensure smooth operations in both current and future states.
}
