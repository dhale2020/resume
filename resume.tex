...
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item   Project Manager charged with overseeing all coordination with MTA IT for all updates to internal systems. 
            Responsiblities included defining acceptance criteria, performing QA UAT testing, triaging projects based on available resources, and performing user trainings on the updated software.
