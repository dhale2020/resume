...
\header{Skills}
\begin{tabular}{ l l }
	Programming: & Python, R, JavaScript, Google Apps Script, SQL, BigQuery, Git, Clasp\\
    Processes: & Documentation, Issue Triaging, Project Management, UAT, Data Analytics, REST API, Troubleshooting, Automation\\
\end{tabular}
\vspace{2mm}
